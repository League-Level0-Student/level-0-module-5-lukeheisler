...
public class Code4Life {
	...
	public static void main(String[] args) {
		String time = JOptionPane.showInputDialog("How much time in hours have you spent coding this week?");
		int t = Integer.parseInt(time);
		if(t < 3) {
			JOptionPane.showMessageDialog(null, "Stop watching YouTube and do something productive! Write some code!");
		}
		else if(t > 5) {
			playBatmanTheme();
		}
